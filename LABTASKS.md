...
When the user submits a form on "petForm" app.js gets rid of the text box and puts the text of the name entered, followed by "String Length:" and the string length.
